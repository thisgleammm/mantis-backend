...
func (s *ProductService) ListProductsOffset(ctx context.Context, limit, offset int32, search string) (domain.PaginatedProducts, error) {
	return s.repo.ListOffset(ctx, limit, offset, search)
}
